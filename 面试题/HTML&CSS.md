...
- [ ] 常见的布局模式有什么
- [ ] 普通和模型和怪异盒模型有什么区别，怎么设置
- [ ] CSS 选择器有哪些，权重是多少
- [ ] 优先级最高的操作是什么，如何提高样式的优先级
- [ ] flex 布局的好处有什么
- [ ] flex 布局的常用属性有哪些
- [ ] flex: 1 是什么意思
- [ ] 简单介绍一下 BFC
...
- [ ] 对promise的理解
- [ ] promise.all()的状态怎么确定
- [ ] 链式调用的时候需要每一次都要catch()吗，如果不为什么不需要呢，catch()后面还可以继续then()吗
- [ ] 对 async await 的理解
- [ ] script两个异步加载属性，会推迟到什么时候，两个有什么区别
- [ ] 
